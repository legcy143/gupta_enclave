...
export default function HeroSection() {
    return (
        <section className='pt-[5rem] h-[90vh] max-h-[50rem]  relative mb-[4rem] bg-primary-gradient flex flex-col items-center'>
            <MiddleSection />
            <BottomSection />
        </section>
    )
...
const MiddleSection = ({ className }: { className?: string }) => {
    return (
        <section className={cn('flex  flex-row items-center h-full overflow-hidden', className)}>
            {/* text parts */}
            ...
            {/* image partss */}
            <section className='flex-0 relative overflow-hidden  w-[45%] h-[90%] mt-auto'>
...
const CircleBubble = ({ className }: { className?: string }) => {
    return (
        <div className={cn("rounded-full w-20 aspect-square bg-primary-gradient absolute", className)}></div>
    )
}
...
const BottomSection = ({ className }: { className?: string }) => {
    ...
    return (
        <section className={cn("bg-background rounded-full px-5 absolute h-[6rem] bottom-[-3rem] w-[95%] md:w-[70%] shadow-md flex items-center justify-around", className)}>
            {
                options?.map((e, i) => {
                    return (
